...
class ServerLogic:
    def __init__(self, name, component):
        ...
        self.escooters = [{"id": 1, "location": (4.7, 5.7), 'busy': False}]
        ...
        * throw the message away.
        ...
        if not command:
            ...
            try:
                ...
                self.server_logic[server_name].receive_destination(payload.get('location'), self.server_logic[server_name].destination)
...
def create_machine(self, server_name, component):
    ...
    """
    server_stm = Machine(name=server_name, transitions=[t0, t1, t2, t3, t4, t5, t6, t7, t8], obj=self)
    self.stm = server_stm
    return server_stm
